...
- **[OthmanAdi/planning-with-files](https://github.com/OthmanAdi/planning-with-files):** Submitted **Awesome RAG Production** — a hand-picked collection of battle-tested tools, patterns, and references for shipping reliable RAG applications to production ([PR #198](https://github.com/OthmanAdi/planning-with-files/pull/198)) and ([PR #199](https://github.com/OthmanAdi/planning-with-files/pull/199)) &nbsp;<img src="https://img.shields.io/github/stars/OthmanAdi/planning-with-files?style=social" alt="stars" valign="middle">
