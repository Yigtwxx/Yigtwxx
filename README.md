...
- **[openclaw/openclaw](https://github.com/openclaw/openclaw):** Diagnosed and fixed a P0 bug in openclaw (open-source AI assistant), where the Windows Gateway installed but never started for accounts with non-ASCII profile paths, by encoding generated .cmd launchers to the system's boot-time OEM code page instead of UTF-8. ([PR #108967](https://github.com/openclaw/openclaw/pull/108967)) &nbsp;<img src="https://img.shields.io/github/stars/openclaw/openclaw?style=social" alt="stars" valign="middle">
