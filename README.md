...
- **[OthmanAdi/planning-with-files](https://github.com/OthmanAdi/planning-with-files):** Established the project's first CI pipeline — a GitHub Actions workflow running the pytest suite on Ubuntu and Windows plus vitest for the Pi extension — after fixing two latent cross-platform test failures the first runner execution exposed ([PR #198](https://github.com/OthmanAdi/planning-with-files/pull/198)) and ([PR #199](https://github.com/OthmanAdi/planning-with-files/pull/199)) &nbsp;<img src="https://img.shields.io/github/stars/OthmanAdi/planning-with-files?style=social" alt="stars" valign="middle">
